...
export default async function LoginPage({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-screen bg-[#0a0a1a] relative overflow-hidden">
      ...
      {/* Background effects */}
      <div className="absolute top-[-20%] left-[-15%] w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-15%] w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="w-full max-w-md px-4 sm:px-0 z-10 animate-slide-up">
        ...
        <div className="text-center mb-10">
          <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-white to-indigo-300/60 tracking-tight">
            Welcome Back
          </h1>
          <p className="text-indigo-200/40 mt-3 font-medium">Sign in to your account to continue</p>
        </div>
        ...
        <div className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.06] rounded-3xl p-8 shadow-[0_0_60px_rgba(0,0,0,0.3)]">
          <form className="flex flex-col gap-6" action={login}>
            ...
            <div>
              ...
              <input
                className="w-full rounded-xl bg-white/[0.06] border border-white/[0.08] px-4 py-3.5 text-white placeholder-white/20 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 outline-none transition-all"
                name="email"
            ...
            <Button variant="primary" fullWidth className="mt-2 text-md py-4 rounded-xl shadow-[0_0_30px_rgba(139,92,246,0.2)]">
              Sign In
            </Button>
